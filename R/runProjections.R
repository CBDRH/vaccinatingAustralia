...
## Check results
check_results(sc1, units = 80000, gapEnd = 3*7, gapStart = 4*7)
check_results(sc2, units = 80000, gapEnd = 3*7, gapStart = 4*7)
check_results(sc3, units = 80000, gapEnd = 12*7, gapStart = 13*7)
check_results(sc4, units = 80000, gapEnd = 12*7, gapStart = 13*7)
check_results(sc5, units = 200000, gapEnd = 3*7, gapStart = 4*7)
check_results(sc6, units = 200000, gapEnd = 3*7, gapStart = 4*7)
check_results(sc7, units = 200000, gapEnd = 12*7, gapStart = 13*7)
check_results(sc8, units = 200000, gapEnd = 12*7, gapStart = 13*7)
beepr::beep(8)
