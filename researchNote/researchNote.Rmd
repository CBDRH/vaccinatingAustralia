...
```{r, fig.align='center', fig.cap='Daily COVID-19 vaccines administered per one million population', fig.subcap='(source: ourworldindata.org'}
...
```{r, fig.cap='Cumulative vaccine doses over time', fig.height=9, fig.width=6.5, fig.align='center'}

fig1a <- plotScenario(sc7, 'A. Scenario 7 (60,000 units per day)')
fig1b <- plotScenario(sc1, 'B. Scenario 1 (80,000 units per day)')
fig1c <- plotScenario(sc9, 'C. Scenario 9 (160,000 units per day)')

ggpubr::ggarrange(fig1a, fig1b, fig1c,
                  ncol = 1, 
                  common.legend = TRUE, 
                  legend = 'bottom')
